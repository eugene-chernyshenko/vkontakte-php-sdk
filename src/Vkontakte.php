...
class Vkontakte
{
     ...
     * @return bool
     */
    public function postToPublic($publicID, $text, $tags = [])
    {
        if ($tags) {
            $text .= "\n\n";
        }
     ...
     */
    public function postToPublicWithImage($publicID, $text, $fullServerPathToImage, $tags = array())
    {
        ...
        $output    = [];
        exec("curl -s -X POST -F 'photo=@$fullServerPathToImage' '$uploadURL'", $output);
